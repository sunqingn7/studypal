...
import {
  useSessionStore,
  FileHistoryItem,
} from "../../application/store/session-store";
...
const getFileIcon = (filename: string) => {
  ...
  switch (ext) {
    ...
    case "jsx":
      return (
        <FileCode className="w-4 h-4 text-yellow-500 dark:text-yellow-400" />
      );
    case "ts":
    case "tsx":
    ...
    case "htm":
      return (
        <FileCode className="w-4 h-4 text-orange-500 dark:text-orange-400" />
      );
    case "png":
    case "jpg":
    case "jpeg":
    case "gif":
      return (
        <FileImage className="w-4 h-4 text-purple-500 dark:text-purple-400" />
      );
    default:
